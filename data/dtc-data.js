...
export const dtcData = {
  ...
  P0705: {
    ...
    description: "Công tắc vị trí Park/Neutral (PNP switch) phát hiện vị trí cần số (P, R, N, D, 2, L) và gửi tín hiệu đến ECM. ECM nhận được 2 hoặc nhiều tín hiệu vị trí cùng lúc, hoặc tất cả tín hiệu đều OFF, hoặc tín hiệu L/3 bật khi đang ở P/R/N → ECM kết luận có lỗi và lưu DTC P0705.",
    detection_logic: {
    ...
    steps: [
      ...
      },
      {
        ...
        purpose: "Kiểm tra đường dây, giắc nối có hỏng không, nguồn cấp điện có đủ không",
    ...
    steps: [
      {
        ...
        question: "Nhiệt độ hiển thị có ở mức bình thường không (20°C - 100°C)?",
        answers: {
      ...
      },
      {
        ...
        actions: [
          "Ngắt connector C28 (dây truyền hộp số)",
          "Đo điện trở"
        ],
        table: {
  ...
  P0712: {
    ...
    group: "sensor-temp-atf",
    wiring_image: "assets/images/dtc/p0713-wiring-1.png",
    description: "Khi cảm biến nhiệt độ ATF báo điện trở thấp (< 79Ω) trong 0.5s trở lên, ECM xác định là ngắn mạch và lưu DTC P0712. Nhiệt độ 150°C trở lên được hiển thị bất kể nhiệt độ thực.",
    detection_logic: {
      summary: "Điện trở cảm biến < 79 Ω trong 0.5 giây trở lên",
      conditions: ["Điện trở < 79 Ω duy trì ≥ 0.5s"]
    },
    trouble_area: ["Ngắn mạch cảm biến ATF", "Dây truyền (ATF temp sensor)", "ECM"],
  ...
  P0713: {
    ...
    group: "sensor-temp-atf",
    wiring_image: "assets/images/dtc/p0713-wiring-1.png",
    description: "Khi cảm biến nhiệt độ ATF báo điện trở cao (> 156 kΩ) trong 0.5s trở lên (sau 15 phút khởi động), ECM xác định là hở mạch. Nhiệt độ -40°C được hiển thị bất kể nhiệt độ thực.",
    detection_logic: {
      summary: "Điện trở cảm biến > 156 kΩ trong 0.5 giây trở lên",
      conditions: ["Điện trở > 156 kΩ", "Sau 15 phút khởi động động cơ"]
    },
    trouble_area: ["Mở mạch cảm biến ATF", "Dây truyền (ATF temp sensor)", "ECM"],
  ...
  P0711: {
    ...
    mil: "Sáng",
    group: "sensor-temp-atf",
    description: "Cảm biến nhiệt độ ATF chuyển đổi nhiệt độ dầu thành giá trị điện trở. Khi nhiệt độ tăng, điện trở giảm. ECM tính toán nhiệt độ dựa trên tín hiệu điện áp. Nếu nhiệt độ ATF dưới 20°C sau khi xe vận hành một thời gian, hoặc đạt 100°C+ khi nhiệt độ nước làm mát đạt 60°C → ECM xác định lỗi.",
    detection_logic: {
    ...
    trouble_area: ["Mức dầu ATF thấp", "Dây truyền (cảm biến nhiệt độ ATF)", "ECM"],
    steps: [
      {
        id: 1,
      ...
      },
      {
        ...
        actions: ["Kiểm tra mức dầu ATF theo quy trình chuẩn trong tài liệu chính thống"],
  ...
  P0717: {
    ...
    description: "Cảm biến này phát hiện tốc độ quay của trục đầu vào của hộp số. Bằng cách so sánh tín hiệu tốc độ tuabin đầu vào (NT) với tín hiệu cảm biến tốc độ đầu ra (SPD), ECM phát hiện thời điểm chuyển số và điều khiển mô-men xoắn động cơ + áp suất thủy lực phù hợp, từ đó thực hiện việc chuyển số mượt mà.",
    detection_logic: {
    ...
    steps: [
      {
        ...
        purpose: "Kiểm tra bu lông siết chặt + không có khe hở giữa cảm biến và vỏ hộp số",
        ...
        answers: {
          yes: { next_step: 2, label: "Đến Bước 2" },
          no: { result: "Lắp đặt hoặc thay thế cảm biến vòng quay hộp số an toàn" }
        }
      },
      {
        id: 2,
  ...
  P0751: {
    ...
    wiring_image: "assets/images/dtc/p0751-wiring.png",
    description: 'Mã lỗi DTC này cho biết "lỗi kẹt ở trạng thái BẬT" hoặc "lỗi kẹt ở trạng thái TẮT" của van điện từ chuyển số S1. ECM điều khiển việc chuyển số bằng cách bật/tắt các van điện từ. Khi vị trí số do ECM chỉ định và vị trí số thực tế không khớp, ECM bật MIL và lưu DTC. ECM dùng tín hiệu từ cảm biến tốc độ xe + NT để phát hiện vị trí số thực tế (1, 2, 3, 4).',
    detection_logic: {
    ...
    steps: [
      {
        ...
        actions: [
          "Tháo van điện từ chuyển số S1",
          "Đo điện trở"
        ],
        table: {
          headers: ["Cách đo", "Điện trở tiêu chuẩn"],
          rows: [
            ["Nối cực (+) vào giắc, cực (-) vào thân van", "11 tới 15 Ω ở 20°C (68°F)"]
          ]
        },
        question: "Điện trở có đạt tiêu chuẩn không?",
        answers: {
  ...
  P0756: {
    ...
    mil: "Sáng",
    group: "solenoid-shift",
    wiring_image: "assets/images/dtc/p0756-wiring.png",
    description: 'Tương tự P0751 nhưng cho van S2. ECM điều khiển chuyển số bằng cách bật/tắt van điện từ. Khi vị trí số ECM chỉ định và thực tế không khớp, ECM bật MIL và lưu DTC.',
    detection_logic: {
      summary: "Logic phát hiện 2 vòng lái xe",
      conditions: [
    ...
    steps: [
      {
        ...
        actions: [
          "Tháo van điện từ chuyển số S2",
          "Đo điện trở"
        ],
        table: {
          headers: ["Cách đo", "Điện trở tiêu chuẩn"],
          rows: [["Nối cực (+) vào giắc, cực (-) vào thân van", "11 tới 15 Ω ở 20°C (68°F)"]]
        },
        question: "Điện trở có đạt tiêu chuẩn không?",
        answers: {
          yes: { next_step: 2, label: "Đến Bước 2" },
  ...
  P0787: {
    ...
    description: "Khi có hiện tượng hở mạch hoặc ngắn mạch trong mạch van điện từ chuyển số, ECM phát hiện sự cố và đèn MIL sáng lên. Van điện từ chuyển số ST được đóng-mở-tắt theo tín hiệu từ ECM khi chuyển số lên/xuống giữa số 3 và số 4, giúp giảm hiện tượng giật khi chuyển số.",
    detection_logic: {
      summary: "Logic phát hiện 1 vòng lái xe",
      conditions: ["ECM phát hiện ngắn mạch trong mạch van điện từ ST 4 lần khi van đang hoạt động"]
    },
    trouble_area: [
    ...
    steps: [
      {
        ...
        actions: [
          "Tháo đầu nối dây truyền động ra khỏi hộp số",
          "Đo điện trở"
        ],
        table: {
          headers: ["Chân kết nối", "Điện trở tiêu chuẩn"],
      ...
      },
      {
        ...
        table: {
          headers: ["Chân kết nối", "Điện trở tiêu chuẩn"],
          rows: [["Đầu nối van (ST) - Thân van (ST)", "11 tới 15 Ω ở 20°C (68°F)"]]
        },
  ...
  P0788: {
    ...
    group: "solenoid-st",
    wiring_image: "assets/images/dtc/p0788-wiring.png",
    description: "Tương tự P0787 nhưng cho trường hợp hở mạch trong mạch van điện từ ST.",
    detection_logic: {
      summary: "Logic phát hiện 1 vòng lái xe",
      conditions: ["ECM phát hiện mạch hở trong van điện từ ST 4 lần khi van không hoạt động"]
    },
    trouble_area: [
  ...
  P0973: {
    ...
    steps: [
      ...
      },
      {
        ...
        table: {
          headers: ["Chân kết nối", "Điện trở tiêu chuẩn"],
          rows: [["Đầu nối van (S1) - Thân van (S1)", "11 tới 15 Ω ở 20°C (68°F)"]]
        },
  ...
  P0974: {
    ...
    group: "solenoid-circuit",
    wiring_image: "assets/images/dtc/p0974-wiring.png",
    description: "Tương tự P0973 nhưng cho trường hợp hở mạch ở van điện từ S1.",
  ...
  P0976: {
    ...
    description: "Tương tự P0973 nhưng cho van S2. Khi xảy ra hở mạch hoặc ngắn mạch trong mạch van S2, ECM phát hiện và bật MIL. Khi đó, ECM thực hiện cơ chế an toàn và bật/tắt van còn lại bình thường.",
    detection_logic: {
    ...
    steps: [
      ...
      },
      {
        ...
        table: {
          headers: ["Chân kết nối", "Điện trở tiêu chuẩn"],
          rows: [["Đầu nối van (S2) - Thân van (S2)", "11 tới 15 Ω ở 20°C (68°F)"]]
        },
        question: "Van điện từ có phát ra âm thanh không?",
        answers: {
          yes: { result: "Sửa chữa hoặc thay thế dây truyền động" },
  ...
  P0977: {
    ...
    group: "solenoid-circuit",
    wiring_image: "assets/images/dtc/p0977-wiring.png",
    description: "Tương tự P0976 nhưng cho trường hợp hở mạch ở van điện từ S2.",
  ...
  P2714: {
    ...
    steps: [
      ...
      },
      {
        ...
        image: "assets/images/dtc/p2714-step3.png",
  ...
  P2716: {
    ...
    mil: "Sáng",
    group: "solenoid-pressure",
    wiring_image: "assets/images/dtc/p2716-wiring.png",
    description: "Solenoid SLT điều khiển áp suất dầu chính bằng tín hiệu duty ratio từ ECM. Khi có hở mạch hoặc chập mạch kéo dài ≥ 1 giây trong lúc xe chạy, ECM nhận biết lỗi → bật MIL ngay và lưu DTC.",
  ...
  P2759: {
    ...
    mil: "Sáng",
    group: "solenoid-lockup",
    wiring_image: "assets/images/dtc/p2759-wiring.png",
    description: "Solenoid SLU kiểm soát áp suất lock-up clutch. ECM điều khiển bằng tín hiệu duty ratio. Khi có hở/chập mạch kéo dài ≥ 1 giây khi xe chạy → ECM phát hiện lỗi → bật MIL ngay và lưu DTC.",
    trouble_area: ["Mạch hở/ngắn mạch van SLU", "Van điện từ SLU", "ECM"],
    steps: [
      {
        id: 1,
        title: "Kiểm tra dây dẫn truyền động (Van điện từ SLU)",
        image: "assets/images/dtc/p2759-step1.png",
        actions: ["Tháo đầu nối dây truyền động ra khỏi hộp số", "Đo điện trở"],
        table: {
          headers: ["Chân kết nối", "Điện trở tiêu chuẩn"],
          rows: [
      ...
      },
      {
        id: 2,
        title: "Kiểm tra bộ dây và đầu nối (Dây hộp số → ECM)",
        image: "assets/images/dtc/p2759-step2.png",
        actions: [
          "Kết nối đầu nối hộp số",
          "Ngắt kết nối đầu nối ECM",
          "Đo điện trở"
      ...
      },
      {
        id: 3,
        title: "Kiểm tra van điện từ SLU",
        image: "assets/images/dtc/p2759-step3.png",
        actions: [
          "Tháo van điện từ SLU",
          "Đo điện trở",
          "Nối cực (+) có bóng đèn 21W vào cực 2 và cực (-) vào cực 1"
...
for (const code in dtcData) {
  ...
  if (entry.same_flow_as && dtcData[entry.same_flow_as]) {
    ...
    entry.detection_logic = entry.detection_logic || dtcData[entry.same_flow_as].detection_logic;
  }
}
...
export const dtcGroups = {
  ...
  "sensor-temp-atf": { label: "Cảm biến nhiệt độ ATF", codes: ["P0710", "P0711", "P0712", "P0713"] },
  ...
  "solenoid-circuit": { label: "Mạch điều khiển van", codes: ["P0973", "P0974", "P0976", "P0977"] },
  "solenoid-pressure": { label: "Van điện từ SLT", codes: ["P2714", "P2716"] },
  "solenoid-lockup": { label: "Van điện từ SLU (Lock-up)", codes: ["P2757", "P2759"] }
};
